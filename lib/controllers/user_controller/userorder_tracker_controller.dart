...
import 'package:pet/models/usersModel/orderTrackerModel.dart';

import 'package:pet/utils/api_helper.dart';
import 'package:pet/utils/constants.dart';

class OrderTrackerUserController extends GetxController {
  bool showLoading = false;
  int? orderId;
// tracker
  String getOrderTrackerUrl = '${Constants.GET_ORDER_TRACKER}';
  UserOrderTrackerModel? ordertrackermodel;
  ...
  Future<void> init() async {
    ...
    try {
      // categories
      ordertrackermodel = UserOrderTrackerModel.fromJson(
