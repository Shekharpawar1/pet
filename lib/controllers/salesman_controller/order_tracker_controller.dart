...
class OrderTrackerSalesController extends GetxController {
  bool showLoading = false;
  int? orderId;
// tracker
  String getOrderTrackerUrl = '${Constants.GET_ORDER_TRACKER}';
  salesOrderTrackerModel? ordertrackermodel;
  ...
  updateOrder(int? orderid) {
    orderId = orderid;
    update();
    print("OrderTackerIDSales :${orderId}");
  }
  ...
  Future<void> init() async {
    ...
    try {
      ...
      ordertrackermodel = salesOrderTrackerModel.fromJson(
