...
class _CommonState extends State<Common> {
  ...
  child:  Scaffold(
      ...
      Padding(
                         ...
                         InkWell(
                          onTap: (){
                           ...
                           child: Container(
                            ...
                            Image.asset("assets/image/wholesale.png",width: 80,
                               height: 80,),
                                         ...
                                         Padding(
                                           padding: const EdgeInsets.all(5.0),
                                           child: Text(
                                                  'Login as a \n Wholesaler',textAlign: TextAlign.center,
                                                  style:  CustomTextStyle.  popinsmedium
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Column( mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
                            ...
                            Image.asset("assets/image/saleman.png",width: 80,
                height: 80,),
                ...
                Padding(
                  padding: const EdgeInsets.all(5.0),
                  child: Text(
                         'Login as a \n Sales Man',textAlign: TextAlign.center,
                         style:  CustomTextStyle.popinsmedium
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Column( mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
                            ...
                            Image.asset("assets/image/partner.png",width: 80,
                height: 80,),
                ...
                Padding(
                  padding: const EdgeInsets.all(5.0),
                  child: Text(
                         'Login as a \n Become A Partner',textAlign: TextAlign.center,
                         style:  CustomTextStyle.popinsmedium
       ...
       Align(alignment:Alignment.bottomCenter,child: Image.asset("assets/image/catdogimg.png"))
        ],
      ),
    )
 ); }
