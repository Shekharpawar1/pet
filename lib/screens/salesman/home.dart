...
SalesOurBrandDetailsController salesOurBrandDetailsController = Get.put(SalesOurBrandDetailsController());
  @override
                          ...
                          builder: (_) {
                            return homesalecontroller.salesBrandModel == null
                                ...
                                : ListView.builder(
                                    ...
                                    scrollDirection: Axis.horizontal,
                                    shrinkWrap: true,
                                    itemCount: homesalecontroller.salesBrandModel!.data!.length,
                                    itemBuilder: (context, index) {
                                      var item = homesalecontroller.salesBrandModel!.data![index];
                                      // print(item.name!);
                                      var imagePath =
                                          "${Constants.BASE_URL}${Constants.BRAND_IMAGE_PATH}${item.image ?? ""}";
                                      var imageLogoPath =
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          salesOurBrandDetailsController.addproduct(
                                              item.id ?? 0, item.logo ?? '');
                          ...
                          builder: (_) {
                            return !homesalecontroller.partnerLoaded
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                   itemCount: homesalecontroller
                                        .salesProductPartnerModel!.data!
                                      
                                        .length,
                                    itemBuilder: (context, index) {
                                      var item = homesalecontroller
                                        .salesProductPartnerModel!.data![index];
                    ...
                    GetBuilder<SalesMyCartController>(
                        ...
                        builder: (_) {
                          return ListView.builder(
                            ...
                            scrollDirection: Axis.horizontal,
                            shrinkWrap: true,
                            itemCount: mycartController.mycartmodel!.data!.length,
                            itemBuilder: (context, index) {
                              var item = mycartController.mycartmodel!.data![index];
                           String imagePath =
                                        Constants.PRODUCT_HOME_IMAGE_PATH +
                                            "/${item.image!}";
