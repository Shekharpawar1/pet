...
class Completedsales extends StatefulWidget {
  const Completedsales({super.key});

  @override
  State<Completedsales> createState() => _CompletedsalesState();
}

class _CompletedsalesState extends State<Completedsales> {
