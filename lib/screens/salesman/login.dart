                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: IntlPhoneField(
                      //  obscureText : false,
                      controller: saleslogincontroller.phoneNumberController,
             ...
             SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                 InkWell(
                  onTap: () async {
                        ...
                        final CreateAccountControllersales userHomeController =
                            Get.find<CreateAccountControllersales>();
                       userHomeController.onInit();
                       await 
                         Navigator.push(context, MaterialPageRoute(builder: (context)=>CreateAccountsales()));
