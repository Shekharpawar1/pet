...
WholeReviewController wholeReviewController = Get.put(WholeReviewController());
...
// SizedBox():
      ...
      ListView(
        ...
        children: [
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                width: 60,
                                decoration: BoxDecoration(
                                    color: wholeproductdetailsController.isAdding
                                        ? MyColors.pink
                                        : MyColors.grey,
          ...
          GetBuilder<WholeProductDetailsController>(
              ...
              builder: (_) {
                 final variations = wholeproductdetailsController.productdetailwholemodel!.data!.variations!.length;
                // var product = productdetailscontro
                // printller.productList.length;
                return 
             (wholeproductdetailsController!.productdetailwholemodel!.data == null )?SizedBox(
   ...
   wholeproductdetailsController.productdetailwholemodel!.data!.variations ==
                                null
                                 && wholeproductdetailsController.productdetailwholemodel!.data!.variations ==
                                ""
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonFormField<variantFile.Variations>(
                                  ...
                                  value: wholeproductdetailsController
                                          .selectedvariants,
...
// ).toList() ?? [],
                          ...
                          Row(
                            children: [
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                       wholeproductdetailsController.selectedvariants?.price == null?
                                  Text(
                                       
                                          "₹"+ ( (wholeproductdetailsController.productdetailwholemodel!.data!.price!)*(wholeproductdetailsController.sizecount??0)).toString(),
                            ...
                            //  (     (wholeproductdetailscontroller.productList.price)! * (wholeproductdetailscontroller.productList.discount!)/100).toString()
                                          ...
                                          "₹"+ ( (wholeproductdetailsController.selectedvariants?.price??0)*(wholeproductdetailsController.sizecount??0)).toString(),
                            ...
                            //  (     (wholeproductdetailscontroller.productList.price)! * (wholeproductdetailscontroller.productList.discount!)/100).toString()
                                  ...
                                  SizedBox(height: 5),
                                    wholeproductdetailsController.selectedvariants?.price == null?
                                 Text(
                                    "₹"+((wholeproductdetailsController.productdetailwholemodel!.data!.price!)*(wholeproductdetailsController.sizecount??0)-(  ( (wholeproductdetailsController.productdetailwholemodel!.data!.price!)*wholeproductdetailsController.sizecount??0)*(wholeproductdetailsController.productdetailwholemodel!.data!.discount!)/100)).toString(),
                                  //  "₹"+(  (     (wholeproductdetailscontroller.productdetailwholemodel!.data!.price)! * (wholeproductdetailscontroller.productdetailwholemodel!.data!.discount!)/100)* wholeproductdetailscontroller.sizecount).toString(),
                                    ...
                                    "₹"+((wholeproductdetailsController.selectedvariants?.price??0)*(wholeproductdetailsController.sizecount??0)-(  ( (wholeproductdetailsController.selectedvariants?.price??0)*wholeproductdetailsController.sizecount??0)*(wholeproductdetailsController.productdetailwholemodel!.data!.discount!)/100)).toString(),
                                  //  "₹"+(  (     (wholeproductdetailscontroller.productdetailwholemodel!.data!.price)! * (wholeproductdetailscontroller.productdetailwholemodel!.data!.discount!)/100)* wholeproductdetailscontroller.sizecount).toString(),
                                    //  "₹${wholeproductdetailscontroller.productdetailwholemodel!.data!.price.toString()}",
                                    style: CustomTextStyle.popinstext,
                                  ),
                      ...
                      Text(
                      wholeproductdetailsController.productdetailwholemodel!.data!.description.toString(),
                        style: CustomTextStyle.popinssmall0,
                      ),
                      SizedBox(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                           (wholeproductdetailsController.productdetailwholemodel!.data!.veg == 1)?"Veg":"Nonveg",
                            style: CustomTextStyle.popinstext,
                          ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            wholeproductdetailsController.productdetailwholemodel!.data!.module!.moduleName.toString(),
                            style: CustomTextStyle.popinstext,
                          ),
                        ],
                      ),
                      ...
                      GetBuilder<WholeReviewController>(
                          ...
                          builder: (_) {
                            return ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount:
                                  wholeReviewController.getreviewList.length,
                              itemBuilder: (context, index) {
                                var item =
                                    wholeReviewController.getreviewList[index];
                                ...
                                return ListView(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        RatingStars(
                                          value: wholeReviewController.value!,
                                          // onValueChanged: (v) {
                                          //   //
                                          //   setState(() {
                                          //     value = v;
    ...
    "₹"+ ( (wholeproductdetailsController.selectedvariants?.price??0)*(wholeproductdetailsController.sizecount??0)).toString(),
                                  ...
                                  Text(
                                    ...
                                    (( (wholeproductdetailsController.productdetailwholemodel!.data!.price!)*wholeproductdetailsController.sizecount??0)*(wholeproductdetailsController.productdetailwholemodel!.data!.discount!)/100)
                                    ).toString(),
   ...
   (
                  ...
                  builder: (_) {   
                            return      InkWell(
                                   ...
                                   await wholeproductdetailsController.addProduct();
                                       mycartwholeController.init();
                                      Get.to(AddToCardwhole());
