...
class LocationPickerMapWhole1 extends StatefulWidget {
  @override
  _LocationPickerMapWhole1State createState() => _LocationPickerMapWhole1State();
}

class _LocationPickerMapWhole1State extends State<LocationPickerMapWhole1> {
...
//
          child: Text(
            "Order ID: ${ordertrackwholecontroller.orderId}",
            style: TextStyle(
              fontSize: 16,
                            ...
                            return ListView(
                              ...
                              children: [
                                OrderTracker(
                                  ...
                                  status: ordertrackwholecontroller.orderStatus,
