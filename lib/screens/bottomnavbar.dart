        ...
        child:  BottomNavigationBar(
          ...
          items:  [
            BottomNavigationBarItem(
              icon:  SvgPicture.asset("assets/image/home.svg",color:_currentIndex==0?MyColors. yellow:MyColors. white),
            ...
            //  icon: Image.asset("asset/images/doctor.png",color:_currentIndex==1?buttoncolor:hinttext.withOpacity(.60)),
              icon: SvgPicture.asset("assets/image/service.svg",color:_currentIndex==1?MyColors. yellow:MyColors. white),

              label: 'Service',
            ),
            BottomNavigationBarItem(
              //icon: Image.asset("asset/images/nurse.png",color:_currentIndex==2?buttoncolor:hinttext.withOpacity(.60)),
              icon: SvgPicture.asset("assets/image/petimg.svg",color:_currentIndex==2?MyColors.yellow:MyColors.white),
              label: 'Mypet',
              
            ),
            BottomNavigationBarItem(
            //  icon: Image.asset("asset/images/ambulance1.png",color:_currentIndex==3?buttoncolor:hinttext.withOpacity(.60)),
              icon: SvgPicture.asset("assets/image/profilepet.svg",color:_currentIndex==3?MyColors.yellow:MyColors.white),
              label: 'Profile',
            ),
