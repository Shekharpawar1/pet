...
class OtpPartner extends StatefulWidget {
  const OtpPartner({super.key});

  @override
  State<OtpPartner> createState() => _OtpPartnerState();
}

class _OtpPartnerState extends State<OtpPartner> {
     ...
     child: Column(
       children: [
         ...
         Image.asset("assets/logo/logo.png"),
                  ...
                  Text("Verification",style: CustomTextStyle.boldStyle,textAlign: TextAlign.center,),
                     SizedBox(height: MediaQuery.of(context).size.height*0.01,),
             Text("Enter OTP code send to your number", style:CustomTextStyle.mediumtext ,),
                SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                 Row(mainAxisAlignment: MainAxisAlignment.center,
                   children: [
                     Text("8839039838", style:CustomTextStyle.mediumtext ,),
