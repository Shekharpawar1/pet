...
class Completedpartner extends StatefulWidget {
  const Completedpartner({super.key});

  @override
  State<Completedpartner> createState() => _CompletedpartnerState();
}

class _CompletedpartnerState extends State<Completedpartner> {
