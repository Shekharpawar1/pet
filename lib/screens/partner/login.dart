       ...
       body: SingleChildScrollView(
         child: Padding(
           ...
           child: Form(
              ...
              Center(
                child: Column(crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    ...
                    Text("Enter your Email and Password",style: CustomTextStyle.boldStyle,textAlign: TextAlign.center,),
                  ],
                ),
              ),
                    ...
                    Padding(
                      ...
                      child: Text("Email", style:CustomTextStyle.mediumtext ,),
                    ),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: 
                              GetBuilder<PartnerLoginController>(
                         ...
                         return       TextFormField(
                                  ...
                                  controller: partnercontroller.emailController,
            ...
            Padding(
                      padding: const EdgeInsets.only(left: 15,right: 15),
                      child: Text("Password", style:CustomTextStyle.mediumtext ,),
                    ),
                 //  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                         ...
                         return     
                                TextFormField(
                                   obscureText: !partnercontroller.passwordVisible,
             ...
             Text("Or",style:  CustomTextStyle.boldStyle,),
               SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                   InkWell(
                    ...
                    child: Center(child: Text("Create  a New Account", style: TextStyle(color:       MyColors.white,
