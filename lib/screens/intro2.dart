  ...
  items: [
    IntroductionSliderItem(
      ...
      title: Padding(
        ...
        child: Text("Find The Pet You Love On\n Around You Easily",textAlign: TextAlign.center,style:  TextStyle(fontSize: 22.0, fontWeight: FontWeight.w700,color:MyColors.white,  fontFamily: "ReemKufi-Regular"),),
      ),
      subtitle:Padding(
        padding: const EdgeInsets.all(8.0),
        child: Text("Lorem Ipsum is simply dummy text of the printing and Lorem I",textAlign: TextAlign.center,style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w400,color:MyColors.white,  fontFamily: "ReemKufi-Regular"),),
      ) ,
...
Text("NEXT",style: CustomTextStyle.mediumtext,),
SizedBox(width: 5,),
