...
=======
                                                            SizedBox(height: 5),
                                                            Text(
                                                              // (     (item.price)! * (item.discount!)/100).toString(),
                                                              "₹" + item.price!,
                                                              style: CustomTextStyle
                                                                  .popinsmedium,
                                                            ),
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return
                                   InkWell(
                                    onTap:(){
ourbranddeatilscontrroller.addproduct(item.id??0, item.logo??'');
print("Brandid${item.id}");
...
<<<<<<< HEAD
                ...
                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                homeusercontroller.userPropertiesModel == null ||
                        homeusercontroller.userPropertiesModel!.data == null
                    ? SizedBox()
                    : GridView.builder(
                        primary: false,
                        shrinkWrap: true,
...
=======
          ...
          //       itemCount: homeusercontroller.userPropertiesModel!.data!.length
          //           .clamp(0, 4),
          //       itemBuilder: (BuildContext ctx, index) {
          //  return       
                   Container(
