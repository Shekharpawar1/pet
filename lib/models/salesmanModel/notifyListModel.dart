...
//   }
// }
class SalesNotifyListModel {
  String? status;
  List<Data>? data;
  List<Notification>? notification;
  String? message;

  SalesNotifyListModel({this.status, this.data, this.notification, this.message});

  SalesNotifyListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
